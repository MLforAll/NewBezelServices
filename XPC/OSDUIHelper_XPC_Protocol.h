...
- (void)showImage:(long long)img onDisplayID:(CGDirectDisplayID)id priority:(unsigned int)prio msecUntilFade:(unsigned int) filledChiclets:(uint8_t)filled totalChiclets:(uint8_t)total locked:(uint8_t)locked;
